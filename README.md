...
### The rack is technically focused on the whole practice loop.
...
### Real-time deterministic effects DSP
...
### Time, space, and cabinet tone stay synchronized
...
- [Effects reference](https://hannes-software.com/practice-rack/help/effects-reference/)
- [Using the looper](https://hannes-software.com/practice-rack/help/looper/)
...
<details>
<summary><strong>What do I need to plug in a guitar or bass?</strong></summary>
...
<details>
<summary><strong>Who uses Practice Rack?</strong></summary>
...
- Bugs: [open a structured bug report](https://github.com/hannes-wan/practice-rack-official/issues/new?template=bug_report.yml)
- Ideas: [request a focused workflow improvement](https://github.com/hannes-wan/practice-rack-official/issues/new?template=feature_request.yml)
- Product help: [documentation and troubleshooting](https://hannes-software.com/practice-rack/help/)
